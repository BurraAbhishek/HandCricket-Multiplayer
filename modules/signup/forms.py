...
class EditprofileForm(SignupForm):
    team_name = forms.CharField(label='Team name', widget=forms.TextInput(attrs={'readonly': 'readonly'}))
    password = forms.CharField(widget=forms.PasswordInput(render_value=True))
    Account_type = forms.CharField(widget=forms.TextInput(attrs={'readonly': 'readonly'}))
